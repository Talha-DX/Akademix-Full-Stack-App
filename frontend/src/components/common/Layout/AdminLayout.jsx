    ...
    <div className="min-h-screen bg-surface">
      <div className="flex">
        ...
        >
          ...
          {!collapsed && <p className="hidden px-6 pt-4 text-xs font-mono uppercase tracking-[0.14em] text-white/50 lg:block">Admin portal</p>}
          <p className="px-6 pt-4 text-xs font-mono uppercase tracking-[0.14em] text-white/50 lg:hidden">Admin portal</p>

          <AdminSidebar active={active} onNavigate={handleNavigate} collapsed={collapsed} onRequestExpand={handleRequestExpand} />
