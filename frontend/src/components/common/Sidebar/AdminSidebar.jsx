 ...
 * (via `onRequestExpand`) so its submenu is visible.
 */
export default function AdminSidebar({ active, onNavigate, collapsed = false, onRequestExpand }) {
        ...
        return (
          <div key={item.key}>
            ...
            >
              ...
              {!collapsed && item.locked && <Lock size={13} className="text-white/50" />}
